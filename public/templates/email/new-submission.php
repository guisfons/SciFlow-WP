<?php
/**
 * Email template: New Submission → Editor.
 *
 * Available vars: $titulo, $evento, $status, $link, $site_name, $message
 */
if (!defined('ABSPATH'))
    exit;
?>
        ...
        <div style="padding:30px;">
            ...
            <div style="text-align:center;margin:30px 0 10px;">
                <a href="<?php echo esc_url($link); ?>"
                    ...
                    <?php esc_html_e('Acessar Painel', 'sciflow-wp'); ?>
                </a>
            </div>
        </div>
        <div style="background:#f4f7fa;padding:15px;text-align:center;font-size:12px;color:#999;">
            <?php echo esc_html($site_name); ?> —
            <?php esc_html_e('Este é um e-mail automático.', 'sciflow-wp'); ?>
        </div>
    </div>
</body>
