<?php
/**
 * Email template: Reviewer Assigned.
 */
if (!defined('ABSPATH'))
    exit;
?>
...
<body style="margin:0;padding:0;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;background:#f4f7fa;">
    <div
        ...
        <div style="background:linear-gradient(135deg,#1a4a6e,#2d7cb5);padding:30px;text-align:center;">
            <h1 style="color:#fff;margin:0;font-size:22px;">
                <?php echo esc_html($site_name); ?>
            </h1>
            <p style="color:rgba(255,255,255,0.85);margin:8px 0 0;font-size:14px;">
                <?php esc_html_e('Trabalho Atribuído Para Revisão', 'sciflow-wp'); ?>
            </p>
        </div>
        <div style="padding:30px;">
            ...
            <div style="text-align:center;margin:30px 0 10px;">
                <a href="<?php echo esc_url($link); ?>"
                    style="display:inline-block;padding:12px 30px;background:#1a4a6e;color:#fff;text-decoration:none;border-radius:6px;font-weight:600;font-size:14px;">
                    <?php esc_html_e('Avaliar Trabalho', 'sciflow-wp'); ?>
                </a>
            </div>
        </div>
